...
###################################################################################3
form_neonFilter = uic.loadUiType("FilterScreen_other.ui")[0]
...
class neonFilter(QDialog,QWidget,form_neonFilter):
    ...
    def loadImageFromFile(self):
        self.qPixmapFileVar = QPixmap()
        self.qPixmapFileVar.load("C:\\Users\\dkan9\\PycharmProjects\\camera_project\\Gallery\\self camera neon.jpg")
